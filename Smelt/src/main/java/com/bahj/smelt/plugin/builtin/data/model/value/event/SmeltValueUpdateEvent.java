 ...
 *
 * @param <V> The type of Smelt value being updated.
 * @param <P> The type of the property being updated (e.g. {@link String} for a {@link SmeltText}).
 */
public interface SmeltValueUpdateEvent<V extends SmeltValue<V>, P> {
    public V getValue();
