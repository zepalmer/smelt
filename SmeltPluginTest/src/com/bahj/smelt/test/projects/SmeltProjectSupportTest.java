package com.bahj.smelt.test.projects;
...
import com.bahj.smelt.natures.ProjectNature;
import com.bahj.smelt.projects.SmeltProjectSupport;

//This source code taken in part or whole from https://cvalcarcel.wordpress.com/2009/07/26/
public class SmeltProjectSupportTest {
    ...
    private void assertProjectDotFileAndStructureAndNatureExist(String projectPath, String name, URI location) throws DocumentException,
            CoreException {
        IProject project = SmeltProjectSupport.createProject(name, location);
